...
When incoming audio level drops below the analysis threshold (`localAudioEnergy <= 0.0025f`), such as during quiet ambient breakdowns, vocal bridges, or extended silence:
